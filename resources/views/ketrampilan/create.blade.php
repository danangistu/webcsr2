...
@section('title')Create Peningkatan Ketrampilan @endsection
    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Tambah Peningkatan Ketrampilan</h3>
            </div>
            <div class="panel-body">
              <form id="default-wizard" action="{{ url('ketrampilan') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <fieldset title="1">
