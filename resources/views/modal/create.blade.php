...
@section('title')Create Bantuan Pengembangan dan Modal Usaha @endsection
    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Tambah Bantuan Pengembangan dan Modal Usaha</h3>
            </div>
            <div class="panel-body">
              <form id="default-wizard" action="{{ url('modal') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <fieldset title="1">
