    ...
    <div class="col-sm-12">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <a href="{{ url('riset/print') }}" class="btn btn-inverse"><span class="fa fa-print"></span> Print</a>
                <a href="{{ url('riset/export') }}" class="btn btn-inverse"><span class="fa fa-download"></span> Export</a>
            </div>
            <div class="panel-body">
