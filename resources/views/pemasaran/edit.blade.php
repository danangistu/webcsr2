...
@section('title')Edit Create Pemasaran Produk @endsection
        ...
        <div class="page-title-box">
            <div class="btn-group pull-right">
                <ol class="breadcrumb hide-phone p-0 m-0">
                    ...
                    <li>
                        <a href="{{ url('pemasaran') }}">Pemasaran Produk</a>
                    </li>
                    <li class="active">
                        Edit Data
                    </li>
    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Edit Pemasaran Produk</h3>
            </div>
            <div class="panel-body">
              {{ Form::model($model, array('route' => array('pemasaran.update', $model->id),'files'=> true,'id'=>'default-wizard', 'method' => 'PUT')) }}
                  {{ csrf_field() }}
                  <fieldset title="1">
