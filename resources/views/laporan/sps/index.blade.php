                    ...
                    <tbody>
                        ...
                        @foreach($models as $model)
                            <tr>
                                ...
                                <td>
                                  <a href="{{ url('laporan-masuk-sps/approve/'.$model->id) }}" class="btn btn-success btn-block"><span class="fa fa-check"></span> Approve</a>
                                  <a href="{{ url('laporan-masuk-sps/revisi/'.$model->id) }}" class="btn btn-warning btn-block"><span class="fa fa-edit"></span> Revisi</a>
                                </td>
                            </tr>
                            @php($i++)
                        @endforeach
