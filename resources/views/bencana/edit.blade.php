...
@section('title')Edit Pelayanan bencana @endsection
        ...
        <div class="page-title-box">
            <div class="btn-group pull-right">
                <ol class="breadcrumb hide-phone p-0 m-0">
                    ...
                    <li>
                        <a href="{{ url('bencana') }}">Pelayanan bencana</a>
                    </li>
                    <li class="active">
                        Edit Data
                    </li>
            ...
            <h4 class="page-title">Pelayanan bencana</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Edit Pelayanan bencana</h3>
            </div>
            <div class="panel-body">
              {{ Form::model($model, array('route' => array('bencana.update', $model->id),'files'=> true,'id'=>'default-wizard', 'method' => 'PUT')) }}
                  {{ csrf_field() }}
                  <fieldset title="1">
