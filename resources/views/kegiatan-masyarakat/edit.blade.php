...
@section('title')Edit Create Partisipasi Kegiatan Masyarakat @endsection
    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Edit Partisipasi Kegiatan Masyarakat</h3>
            </div>
            <div class="panel-body">
              {{ Form::model($model, array('route' => array('kegiatan-masyarakat.update', $model->id),'files'=> true,'id'=>'default-wizard', 'method' => 'PUT')) }}
                  {{ csrf_field() }}
                  <fieldset title="1">
