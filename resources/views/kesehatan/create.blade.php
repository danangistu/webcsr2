        ...
        <div class="page-title-box">
            <div class="btn-group pull-right">
                <ol class="breadcrumb hide-phone p-0 m-0">
                    ...
                    <li>
                        <a href="{{ url('kesehatan') }}">Pelayan Kesehatan</a>
                    </li>
                    <li class="active">
                        Tambah Data
                    </li>
    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Tambah Pelayanan Kesehatan</h3>
            </div>
            <div class="panel-body">
              <form id="default-wizard" action="{{ url('kesehatan') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <fieldset title="1">
