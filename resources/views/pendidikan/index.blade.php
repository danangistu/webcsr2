    ...
    <div class="col-sm-12">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <a href="{{ url('pendidikan/print') }}" class="btn btn-inverse"><span class="fa fa-print"></span> Print</a>
                <a href="{{ url('pendidikan/export') }}" class="btn btn-inverse"><span class="fa fa-download"></span> Export</a>
            </div>
            <div class="panel-body">
